...
import { FiHeart, FiMoon, FiZap, FiStar, FiSun, FiTarget } from 'react-icons/fi';
...
const ORDERS = [
  { id: 'AT-2891', name: 'Yellow Sapphire Ring', icon: <FiSun size={18} />, date: '14 Jun 2026', price: 18500, status: 'Delivered' },
  { id: 'AT-2834', name: '5-Mukhi Rudraksha Mala', icon: <FiMoon size={18} />, date: '28 May 2026', price: 4200, status: 'In Transit' },
  { id: 'AT-2756', name: 'Amethyst Crystal Ball', icon: <FiZap size={18} />, date: '3 May 2026', price: 3800, status: 'Delivered' },
];
    ...
    <div style={{ paddingTop: '64px' }}>
      <div className={styles.layout}>
        <div>
          ...
          <p style={{ color: 'var(--gold)', marginBottom: '2rem', fontFamily: 'Cinzel,serif', fontSize: '0.9rem' }}><FiZap size={14} style={{ marginRight: '0.35rem' }} /> Welcome back, Ayansh</p>
        </div>
          ...
          <div>
            {ORDERS.map(o => (
              <div key={o.id} className={styles.orderItem}>
                <div className={styles.orderImg}>{o.icon}</div>
                <div className={styles.orderInfo}>
                  <div className={styles.orderName}>{o.name}</div>
                  <div className={styles.orderMeta}>Order #{o.id} Â· {o.date} Â· â‚¹{o.price.toLocaleString('en-IN')}</div>
                </div>
          ...
          <div>
            {wishlist.length === 0 ? (
              <div className={styles.empty}>
                <div style={{ fontSize: '3rem', marginBottom: '1rem' }}><FiHeart size={36} /></div>
          ...
          <div>
            ...
            <div className={styles.stonesBox}>
              ...
              <div className={styles.stonesGrid}>
                {[
                  { icon: <FiStar size={24} />, name: 'Yellow Sapphire', planet: 'Jupiter' },
                  { icon: <FiTarget size={24} />, name: 'Emerald', planet: 'Mercury' },
                  { icon: <FiSun size={24} />, name: 'Red Coral', planet: 'Mars' },
                ].map(s => (
